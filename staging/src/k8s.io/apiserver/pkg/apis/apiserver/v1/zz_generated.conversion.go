...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CertIssuer)(nil), (*apiserver.CertIssuer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_CertIssuer_To_apiserver_CertIssuer(a.(*CertIssuer), b.(*apiserver.CertIssuer), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiserver.CertIssuer)(nil), (*CertIssuer)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiserver_CertIssuer_To_v1_CertIssuer(a.(*apiserver.CertIssuer), b.(*CertIssuer), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*RequestValidationRule)(nil), (*apiserver.RequestValidationRule)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_RequestValidationRule_To_apiserver_RequestValidationRule(a.(*RequestValidationRule), b.(*apiserver.RequestValidationRule), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiserver.RequestValidationRule)(nil), (*RequestValidationRule)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiserver_RequestValidationRule_To_v1_RequestValidationRule(a.(*apiserver.RequestValidationRule), b.(*RequestValidationRule), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*X509AuthConfig)(nil), (*apiserver.X509AuthConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_X509AuthConfig_To_apiserver_X509AuthConfig(a.(*X509AuthConfig), b.(*apiserver.X509AuthConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*apiserver.X509AuthConfig)(nil), (*X509AuthConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_apiserver_X509AuthConfig_To_v1_X509AuthConfig(a.(*apiserver.X509AuthConfig), b.(*X509AuthConfig), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1_CertIssuer_To_apiserver_CertIssuer(in *CertIssuer, out *apiserver.CertIssuer, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_v1_CertIssuer_To_apiserver_CertIssuer is an autogenerated conversion function.
func Convert_v1_CertIssuer_To_apiserver_CertIssuer(in *CertIssuer, out *apiserver.CertIssuer, s conversion.Scope) error {
	return autoConvert_v1_CertIssuer_To_apiserver_CertIssuer(in, out, s)
}

func autoConvert_apiserver_CertIssuer_To_v1_CertIssuer(in *apiserver.CertIssuer, out *CertIssuer, s conversion.Scope) error {
	out.Name = in.Name
	return nil
}

// Convert_apiserver_CertIssuer_To_v1_CertIssuer is an autogenerated conversion function.
func Convert_apiserver_CertIssuer_To_v1_CertIssuer(in *apiserver.CertIssuer, out *CertIssuer, s conversion.Scope) error {
	return autoConvert_apiserver_CertIssuer_To_v1_CertIssuer(in, out, s)
}
...
func autoConvert_v1_RequestValidationRule_To_apiserver_RequestValidationRule(in *RequestValidationRule, out *apiserver.RequestValidationRule, s conversion.Scope) error {
	out.Expression = in.Expression
	out.Message = in.Message
	return nil
}

// Convert_v1_RequestValidationRule_To_apiserver_RequestValidationRule is an autogenerated conversion function.
func Convert_v1_RequestValidationRule_To_apiserver_RequestValidationRule(in *RequestValidationRule, out *apiserver.RequestValidationRule, s conversion.Scope) error {
	return autoConvert_v1_RequestValidationRule_To_apiserver_RequestValidationRule(in, out, s)
}

func autoConvert_apiserver_RequestValidationRule_To_v1_RequestValidationRule(in *apiserver.RequestValidationRule, out *RequestValidationRule, s conversion.Scope) error {
	out.Expression = in.Expression
	out.Message = in.Message
	return nil
}

// Convert_apiserver_RequestValidationRule_To_v1_RequestValidationRule is an autogenerated conversion function.
func Convert_apiserver_RequestValidationRule_To_v1_RequestValidationRule(in *apiserver.RequestValidationRule, out *RequestValidationRule, s conversion.Scope) error {
	return autoConvert_apiserver_RequestValidationRule_To_v1_RequestValidationRule(in, out, s)
}
...
func autoConvert_v1_X509AuthConfig_To_apiserver_X509AuthConfig(in *X509AuthConfig, out *apiserver.X509AuthConfig, s conversion.Scope) error {
	if err := Convert_v1_CertIssuer_To_apiserver_CertIssuer(&in.Issuer, &out.Issuer, s); err != nil {
		return err
	}
...
// Convert_v1_X509AuthConfig_To_apiserver_X509AuthConfig is an autogenerated conversion function.
func Convert_v1_X509AuthConfig_To_apiserver_X509AuthConfig(in *X509AuthConfig, out *apiserver.X509AuthConfig, s conversion.Scope) error {
	return autoConvert_v1_X509AuthConfig_To_apiserver_X509AuthConfig(in, out, s)
}

func autoConvert_apiserver_X509AuthConfig_To_v1_X509AuthConfig(in *apiserver.X509AuthConfig, out *X509AuthConfig, s conversion.Scope) error {
	if err := Convert_apiserver_CertIssuer_To_v1_CertIssuer(&in.Issuer, &out.Issuer, s); err != nil {
		return err
	}
...
// Convert_apiserver_X509AuthConfig_To_v1_X509AuthConfig is an autogenerated conversion function.
func Convert_apiserver_X509AuthConfig_To_v1_X509AuthConfig(in *apiserver.X509AuthConfig, out *X509AuthConfig, s conversion.Scope) error {
	return autoConvert_apiserver_X509AuthConfig_To_v1_X509AuthConfig(in, out, s)
}
