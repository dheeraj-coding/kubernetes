...
func (in *AuthenticationConfiguration) DeepCopyInto(out *AuthenticationConfiguration) {
	*out = *in
	...
	if in.X509 != nil {
		...
		*out = make([]X509AuthConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RequestValidationRule) DeepCopyInto(out *RequestValidationRule) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestValidationRule.
func (in *RequestValidationRule) DeepCopy() *RequestValidationRule {
	if in == nil {
		return nil
	}
	out := new(RequestValidationRule)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *X509AuthConfig) DeepCopyInto(out *X509AuthConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new X509AuthConfig.
func (in *X509AuthConfig) DeepCopy() *X509AuthConfig {
	if in == nil {
		return nil
	}
	out := new(X509AuthConfig)
	in.DeepCopyInto(out)
	return out
}
